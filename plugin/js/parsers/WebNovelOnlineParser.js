...
//dead url/ parser
parserFactory.register("webnovelonline.com", () => createWebNovelOnlineParserInstance());
 ...
 */
function createWebNovelOnlineParserInstance() {
    return new WebNovelOnlineParser();
}
