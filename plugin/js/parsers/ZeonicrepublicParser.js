...
parserFactory.register("zeonic-republic.net", () => createZeonicrepublicParserInstance());
 ...
 */
function createZeonicrepublicParserInstance() {
    return new ZeonicrepublicParser();
}
