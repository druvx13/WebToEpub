...
parserFactory.register("zhenhunxiaoshuo.com", () => createZhenhunxiaoshuoParserInstance());
 ...
 */
function createZhenhunxiaoshuoParserInstance() {
    return new ZhenhunxiaoshuoParser();
}
