...
parserFactory.register("readcomiconline.li", () => createReadComicOnlineParserInstance());
 ...
 */
function createReadComicOnlineParserInstance() {
    return new ReadComicOnlineParser();
}
