...
parserFactory.register("worldnovel.online", () => createWorldnovelOnlineParserInstance());
 ...
 */
function createWorldnovelOnlineParserInstance() {
    return new WorldnovelOnlineParser();
}
