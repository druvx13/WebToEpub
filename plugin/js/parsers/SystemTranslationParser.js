...
parserFactory.register("systemtranslation.com", () => createSystemTranslationParserInstance());
 ...
 */
function createSystemTranslationParserInstance() {
    return new SystemTranslationParser();
}
