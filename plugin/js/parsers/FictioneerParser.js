...
//dead urls
parserFactory.register("blossomtranslation.com", () => createFictioneerParserInstance());
parserFactory.register("igniforge.com", () => createFictioneerParserInstance());
parserFactory.register("razentl.com", () => createFictioneerParserInstance());
//these still exist
parserFactory.register("emberlib731.xyz", () => createFictioneerParserInstance());
parserFactory.register("lilyonthevalley.com", () => createFictioneerParserInstance());
parserFactory.register("novelib.com", () => createFictioneerParserInstance());
parserFactory.register("smeraldogarden.com", () => createFictioneerParserInstance());
parserFactory.register("springofromance.com", () => createFictioneerParserInstance());

parserFactory.registerRule(
    (url, dom) => FictioneerParser.isFictioneerTheme(dom) * 0.7,
    () => createFictioneerParserInstance()
);
 ...
 */
function createFictioneerParserInstance() {
    return new FictioneerParser();
}
