...
parserFactory.register("novelsonline.net", () => createNovelsOnlineParserInstance());
parserFactory.register("novelsonline.org", () => createNovelsOnlineParserInstance());
 ...
 */
function createNovelsOnlineParserInstance() {
    return new NovelsOnlineParser();
}
