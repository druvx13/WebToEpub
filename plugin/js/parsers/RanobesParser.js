...
parserFactory.register("ranobes.net", () => createRanobesNetParserInstance());
parserFactory.register("ranobes.top", () => createRanobesNetParserInstance());
parserFactory.register("ranobes.com", () => createRanobesParserInstance());
 ...
 */
function createRanobesParserInstance() {
    return new RanobesParser();
}
 ...
 * New: factory function with method composition
 */
function createRanobesNetParserInstance() {
    return new RanobesNetParser();
}
