...
//dead url
parserFactory.register("lightnovelread.com", () => createLightnovelreadParserInstance());
parserFactory.register("goblinsguide.com", () => createGoblinsguideParserInstance());
 ...
 */
function createLightnovelreadParserInstance() {
    return new LightnovelreadParser();
}
 ...
 * New: factory function with method composition
 */
function createGoblinsguideParserInstance() {
    return new GoblinsguideParser();
}
