...
parserFactory.register("mottruyen.com.vn", () => createMottruyenParserInstance());
parserFactory.register("mottruyen.vn", () => createMottruyenParserInstance());
 ...
 */
function createMottruyenParserInstance() {
    return new MottruyenParser();
}
