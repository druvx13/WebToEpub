...
parserFactory.register("starlightstream.net", () => createStarlightstreamParserInstance());
 ...
 */
function createStarlightstreamParserInstance() {
    return new StarlightstreamParser();
}
