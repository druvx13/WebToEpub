...
//dead url/ parser
parserFactory.register("gamefaqs.gamespot.com", () => createGamefaqsGamespotParserInstance());
 ...
 */
function createGamefaqsGamespotParserInstance() {
    return new GamefaqsGamespotParser();
}
