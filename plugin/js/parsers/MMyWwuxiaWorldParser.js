...
//dead url/ parser
parserFactory.register("m.mywuxiaworld.com", () => createMMyWwuxiaWorldParserInstance());
 ...
 */
function createMMyWwuxiaWorldParserInstance() {
    return new MMyWwuxiaWorldParser();
}
